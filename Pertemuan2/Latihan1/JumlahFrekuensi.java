...
public class JumlahFrekuensi extends JFrame {
    ...
    public JumlahFrekuensi() {
        ...
        labelFrekuensi.setBounds(20, 280, 250, 20);
        ...
        spinnerFrekuensi.setBounds(280, 280, 50, 25);
        this.add(spinnerFrekuensi);

        // Button Simpan
        JButton buttonSimpan = new JButton("Simpan");
        buttonSimpan.setBounds(130, 320, 100, 30);
        ...
        scrollPane.setBounds(20, 360, 350, 150); // Set ukuran area scroll
        this.add(scrollPane);
