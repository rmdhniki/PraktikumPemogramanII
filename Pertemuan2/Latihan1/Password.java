...
public class Password extends JFrame {
    ...
    public Password() {
        ...
        listTabungan.setBounds(130, 270, 200, 80);
        ...
        labelFrekuensi.setBounds(20, 360, 250, 20);
        ...
        spinnerFrekuensi.setBounds(280, 360, 50, 25);
        this.add(spinnerFrekuensi);

        // Button Simpan
        JButton buttonSimpan = new JButton("Simpan");
        buttonSimpan.setBounds(130, 400, 100, 30);
        ...
        scrollPane.setBounds(20, 440, 350, 150); // Set ukuran area scroll
        this.add(scrollPane);
