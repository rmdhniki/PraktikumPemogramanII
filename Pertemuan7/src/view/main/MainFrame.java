...
import java.util.*;
import Pertemuan7.src.model.*;
import Pertemuan7.src.view.jenismember.JenisMemberFrame;
import Pertemuan7.src.view.member.MemberFrame;
import Pertemuan7.src.dao.*;
